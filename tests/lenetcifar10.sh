...
mkdir -p ../tensorboard
mkdir -p ../checkpoints/lenet_cifar10_v3/
...
for i in {1..6}; do
  ...
  mkdir -p "../checkpoints/lenet_cifar10_v3/lenetcifar10_${i}"
  ...
  for PRUNE_AMT in "${PRUNE_AMT_VALS[@]}"; do
    ...
    --train_lr=1e-3 --max_train_lr=0.1 \
      ...
      --checkpoint_dir="../checkpoints/lenet_cifar10_v3/lenetcifar10_${i}"
  done
  ...
  for PRUNE_AMT in "${PRUNE_AMT_VALS[@]}"; do
    ...
    --checkpoint_dir="../checkpoints/lenet_cifar10_v3/lenetcifar10_${i}" --num_prune_epochs=0 --num_train_epochs_before_pruning=0
  done
done